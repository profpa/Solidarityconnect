...
export const CalendarIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} strokeWidth="1.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const UsersIcon = () => (
  <svg {...iconProps} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.653-.084-1.28-.24-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.653.084-1.28.24-1.857m10.5-1.943A2 2 0 0019.5 16h-15a2 2 0 00-1.262 3.557M17 20l-5-5m0 0l-5 5m5-5v-5a3 3 0 016 0v5a3 3 0 01-6 0z" />
  </svg>
);
...
export const CurrencyRupeeIcon = () => (
  <svg {...iconProps} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 8h6m-5 4h5m2 4h-3a2 2 0 01-2-2V6a2 2 0 012-2h1a2 2 0 012 2v1m-6 12h3" />
  </svg>
);
...
export const TicketIcon = ({className = "w-6 h-6"}: {className?: string}) => (
     <svg className={className} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 6.75h0" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 15.75h0" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75h6" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 12.75h0" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M12.75 9h.008v.008h-.008V9z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 15.75h3" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 9h0" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M7.5 9h.008v.008H7.5V9z" />
...
export const QrCodeIcon = () => (
    <svg className="w-16 h-16" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 15.375a.75.75 0 01.75-.75h2.25a.75.75 0 01.75.75v2.25a.75.75 0 01-.75.75h-2.25a.75.75 0 01-.75-.75V15.375z" />
    </svg>
);
